    ...
    return (
      ...
      <img className= 'col s12 taco-logo' src = { logo }/>
        ...
        <h6 className='col s5 offset-s4 font-dosis '>Inicia Sesion</h6>
          ...
          <a className="col s6 offset-s3 waves-effect waves-light btn light-blue darken-4"  ><i className="fab fa-facebook-f"></i>acebook</a>
          <a className="col s6 offset-s3 waves-effect waves-light btn red darken-4"  ><i className="fab fa-google"></i>oogle</a>
